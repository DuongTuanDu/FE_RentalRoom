...
import type { ISendDraftInvoiceRequest } from "@/types/invoice";

interface SendDraftAllInvoicesDialogProps {
  open: boolean;
  onOpenChange: (open: boolean) => void;
  onSubmit: (data: ISendDraftInvoiceRequest) => void;
  isLoading: boolean;
}

export const SendDraftAllInvoicesDialog = ({
  open,
  onOpenChange,
  onSubmit,
  isLoading,
}: SendDraftAllInvoicesDialogProps) => {
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[500px]">
        <DialogHeader>
          ...
          <DialogDescription>
            Gửi tất cả hóa đơn đang ở trạng thái nháp cho người thuê qua email trong kỳ đã chọn
          </DialogDescription>
        </DialogHeader>

...
import { StaffActionsGuide } from "./components/StaffActionsGuide";
...
const StaffManagementLandlord = () => {
  ...
  const [updateStaffStatus, { isLoading: isUpdatingStatus }] =
    useUpdateStaffStatusMutation();
  ...
  const filteredStaff = useMemo(() => {
    ...
    if (statusFilter !== "all") {
      ...
      filtered = filtered.filter(
        (staff) => staff.accountId.isActivated === isActive
      );
    }
  ...
  const handleUpdateStatus = async () => {
    ...
    try {
      const result = await updateStaffStatus({
        staffId: staff._id,
        body: { isActive: !staff.accountId.isActivated },
      }).unwrap();
  ...
  return (
    <div className="min-h-screen">
                            ...
                            <div className="flex items-center justify-center gap-2">
                              ...
                              <DropdownMenu>
                                ...
                                <DropdownMenuContent align="end">
                                  <DropdownMenuItem
                                    onClick={() =>
                                      handleOpenEditPermissionsModal(staff)
                                    }
                                  >
                                  ...
                                  <DropdownMenuItem
                                    onClick={() =>
                                      handleOpenActivatedModal(staff)
                                    }
      ...
      <ModalEditStaffPermissions
        ...
        staffBuildings={
          selectedStaff?.assignedBuildings?.map((b) => b.id) || []
        }
        onSuccess={() => {

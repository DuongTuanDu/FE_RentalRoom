...
export const ContractDetailSheet = ({
  ...
  const { data: contractDetail, isLoading: isLoadingDetail } =
    useGetContractDetailsQuery(contractId || "", { skip: !contractId });
        ...
        <div className="space-y-6 px-8 pb-4">
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                <Label className="text-slate-500">Chu kỳ thanh toán</Label>
                <p className="font-medium">
                  {contractDetail.contract?.paymentCycleMonths
                    ? `${contractDetail.contract.paymentCycleMonths} tháng`
                    : "—"}
                </p>
              </div>
              <div>
